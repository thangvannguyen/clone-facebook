...
import { HomeFilled, UsergroupAddOutlined, VideoCameraOutlined, UserSwitchOutlined, UngroupOutlined } from '@ant-design/icons';
...
function Menu(props) {
    return (
        <div className="header-menu">
            ...
            <Popover content="Trang Chủ" className="header-popover">
            ...
            <Popover content="Watch" className="header-popover">
            ...
            <Popover content="Nhóm" className="header-popover">
                ...
                {/* <Badge count={28} className="header-badge" /> */}
            </Popover>
            <Popover content="Trò chơi" className="header-popover">
